...
class TxtApprovement:
    ...
    def release_to_featers(self):
        return (
            f'Один или несколько ваших треков, в котором вы участвуете,'
            f' был успешно добавлен в релиз <b>"{self.title}"</b>! 🎉🎵\n'
            f'Пожалуйста, пройдите в <b>"👨‍👦‍👦Совместный продакшн"</b>,'
            f' чтобы прикрепить документы для вашего участия в релизе.')
