...
menu = Dialog(
    Window(
        ...
        Const("⚡ Мы ценим ваше время и желаем максимально упростить процесс сотрудничества с нашим лейблом. "
              "Создайте свой профиль всего <b>ОДИН РАЗ</b>, предоставив нам необходимые данные для оформления лицевого "
              "договора, и дальше наслаждайтесь мгновенной публикацией ваших треков на популярных площадках!\n"),
        Const("🔒 <b>Ваша приватность - наш приоритет.</b> После оформления договора, все предоставленные вами данные "
              "удаляются в течение 1-2 дней. Мы гарантируем безопасность и конфиденциальность вашей информации.\n"),
